...
public class FloorActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rec_room_floor1 = findViewById(R.id.rec_room_floor1);
        roomList = new ArrayList<>();
        floorAdapter = new FloorAdapter();
        rec_room_floor1.setLayoutManager(new GridLayoutManager(this, 2));
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot data : snapshot.getChildren()){
                    ...
                    for(DataSnapshot dataFloor : data.child("floors").getChildren()){
                        ...
                        if (bundle.getString("Floor1").equals(idFloor)){
...
//                    Log.i("houseKey" , houseKey);
        ...
        floorAdapter.notifyDataSetChanged();
        rec_room_floor1.setAdapter(floorAdapter);
    }
}